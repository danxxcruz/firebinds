...
**Validation**: Every user story needs validation evidence. Include automated tests
when practical; use documented manual verification only when automation is not
practical or not proportional to the risk.
...
- [ ] T004 [P] Define validation commands or manual checks for this feature
...
> **NOTE: Write automated tests FIRST and ensure they FAIL before implementation**
...
- [ ] T013 [US1] Manual verification for [fallback or UX behavior] if automation is not practical
...
- [ ] T018 [US1] Add validation and error handling for expected failure modes
- [ ] T019 [US1] Add logging or diagnostics needed to understand user story 1 operations
...
- [ ] T022 [US2] Manual verification for [fallback or UX behavior] if automation is not practical
...
- [ ] T029 [US3] Manual verification for [fallback or UX behavior] if automation is not practical
...
- [ ] TXXX [P] Additional unit tests for risky or shared logic in tests/unit/
...
- Automated tests MUST be written and fail before implementation when included
- Manual checks MUST describe exact steps and expected results
...
```bash
# Launch all automated validation for User Story 1 together:
...
- Verify automated tests fail before implementing
- Record manual validation steps when automation is not practical
